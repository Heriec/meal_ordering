<%@page import="com.he.pojo.Orders " %>
<%@page import="java.util.*" %>
<%@ page import="com.he.service.OrdersService" %>
<%@ page import="com.he.service.impl.OrdersServiceImpl" %>
<%@ page import="com.he.pojo.Users" %>
<%@ page import="com.he.pojo.Menus" %>
<%@ page import="com.he.util.Pages" %>
    ...
    <tr>
        ...
        <td valign="top" background="../public/admin/images/content-bg.gif">
            <table
                    ...
                    class="left_topbg" id="table1">
                <tr>
                    <td height="31">
                        <div class="titlebt">订单信息</div>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <div align="center">
                <table id="table2" class="line_table"
                    ...
                    <tr>
                        ...
                        <td class="line_table" align="center"><a href="OrderComfirm?id=<%=order.getId()%>&reqtype=del">取消</a>
                        </td>
                        <%} %>
                    </tr>
                        <%}
...
%>
                    <tr>
                        <td class="line_table" align="center" colspan="12" height="20">
                            <a href="/orders/ordergetall">查询所有订单</a>
								<span class="left_bt2">第<%=pages.getCurrentPage()%>页
										&nbsp;&nbsp;共<%=pages.getTotalPageCount()%>页
								</span>&nbsp;&nbsp;
                            <a href="/orders/pageListByDelivery?currentPage=1&s=first">[首页]</a>
                            <a href="/orders/pageListByDelivery?currentPage=<%=pages.getTotalPageCount()%>&s=last">[尾页]</a>&nbsp;&nbsp;
                            <a href="/orders/pageListByDelivery?currentPage=<%=Integer.parseInt(pages.getCurrentPage())-1%>&s=up">[上一页]</a>
                            <a href="/orders/pageListByDelivery?currentPage=<%=Integer.parseInt(pages.getCurrentPage())+1%>&s=down">[下一页]</a>
                            <a href="/orders/pageListByDelivery" align="right" width="60%">查询未派送订单</a>
                            <%
