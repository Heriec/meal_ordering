            ...
            <div id="container">
                ...
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="${pageContext.request.contextPath}/public/admin/images/menu_topline.gif"
                                     width="182"
                                     height="5"/></td>
                        </tr>
                    </table>
                ...
                <div class="content">
                    ...
                    <ul class="MM">
                        <li><a href="${pageContext.request.contextPath}/public/admin/notice_add.jsp"
                               target="main">添加新通告</a></li>
