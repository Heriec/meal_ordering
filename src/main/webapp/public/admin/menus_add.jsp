...
<%@ page import="com.he.service.TypesService" %>
<%@ page import="com.he.service.impl.TypesServiceImpl" %>
<%@ page import="com.he.controller.TypesController" %>
<html>
<head>
