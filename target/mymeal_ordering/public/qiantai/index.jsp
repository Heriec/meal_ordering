<%@ page import="com.he.pojo.Menus" %>
<%@ page import="com.he.util.ShoppingCar" %>
<%@page import="com.he.pojo.Notice" %>
<%@page import="com.he.dao.NoticeDao" %>
<%@page import="java.text.SimpleDateFormat" %>
<%@page import="java.util.List" %>
<%@page import="com.he.dao.MenusDao" %>
<%@page import="com.he.pojo.Menus" %>
<%@ page import="com.he.service.MenusService" %>
<%@ page import="com.he.service.impl.MenusServiceImpl" %>
<%@ page import="java.util.*" %>
<%@ page import="com.he.util.AlipayUtil" %>
                        ...
                        <div id='pdv_3606'
                            ...
                            <div id='spdv_3606' class='pdv_content'
                                ...
                                <div class="pdv_border"
                                     style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:white;">
                                                ...
                                                <div id="mm_01" class="dingcanall_connow">
                                                    <table>
                                                        <%
                                                            ...
                                                            int rscount = 0;/*实际记录数*/
                                                            //menuList=queryALL
                                                            List<Menus> menusList = (List<Menus>) request.getAttribute("list");
                                                                ...
                                                                <div>
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><span><%=menus.getTypes()%></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2" style="height: 40px;">
                                                                                <a href="/orders/order_addshoppingcar/<%=menus.getId()%>">
                                                                                    <img src="${pageContext.request.contextPath}/public/qiantai/images/cart.png"
                                                                                         border="0" alt=""/>
                                                                                </a>
                                                                            </td>
                                                                            <td></td>
                                        ...
                                        <div id='spdv_3603' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <link href="${pageContext.request.contextPath}/public/qiantai/css/newslist_time2.css"
                                                      rel="stylesheet"
                                                      type="text/css"/>
                                                <link href="${pageContext.request.contextPath}/public/qiantai/css/noticecss.css"
                                                      rel="stylesheet"
                                                      type="text/css"/>
                                                <div id="notice">
                                                    <div id="notice2">
                                                        <div id="notice_top">
                                                            <div id="notice_top_left">餐厅公告</div>
                                                            <div id="notice_top_right">&nbsp;</div>
                                                        </div>
                                                        <div style="padding: 0px;">
                                                            <div class="noticeinfoinfo" align="left">

                                                                <div
                                                                        style="height: 100%; background: url(images/dingcanweekmenu_rightline.jpg) right repeat-y">
                                                                        ...
                                                                        <ul class="newslist_time2">
                                                                            <c:forEach items="${notice}" var="notice">
                                                                                <li class="newslist_time2">
                                                                                    ...
                                                                                    <a href="<c:url value="/notice/queryByIdtoQiantai?id=${notice.id}"/>"
                                                            ...
                                                            <div id="notice_bottom_left">&nbsp;</div>
                                                            <div id="notice_bottom_right">&nbsp;</div>
                                                            <div style="margin-top: -10px; height: 10px; line-height: 10px; background: url(images/bg.jpg) 0px -220px no-repeat">
                                                                &nbsp;
                                                            </div>
                                                            <div style="float: right; margin-top: -10px; width: 10px; height: 10px; line-height: 10px; background: url(images/bg.jpg) -890px -220px no-repeat">
                                                                &nbsp;
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <td valign="top">
                                    <div id='pdv_3614' class='pdv_class' title='我的餐车'
                                        ...
                                        <div id='spdv_3614' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                 style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:white;">
                                                <div style="height: 25px; margin: 1px; display: none; background:white;">
                                                    <div style="float: left; margin-left: 12px; line-height: 25px; font-weight: bold; color:white">
                                                        我的餐车
                                                    </div>
                                                        ...
                                                        <div id="dingcanche2">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <%
                                                                    float sum1 = 0.0f;
                                                                    int sum2 = 0;
                                                                    List<ShoppingCar> shoppingcar = (List<ShoppingCar>) session.getAttribute("shoppingcar");
                                                                    if (shoppingcar != null) {
                                                                        for (int i = 0; i < shoppingcar.size(); i++) {
                                                                            ShoppingCar sc = shoppingcar.get(i);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a href="/orders/order_shoppingcardel?del=<%=i%>">取消</a>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                        }
                                    ...
                                    <div id='pdv_3613' class='pdv_class'
                                        ...
                                        <div id='spdv_3613' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                 style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:white;">
                                                <div
                                                        style="height: 25px; margin: 1px; display: none; background:white;">
                                                    <div style="float: left; margin-left: 12px; line-height: 25px; font-weight: bold; color:white">
                                                        本周菜单
                                                    </div>
                                                        ...
                                                        <div id="dingcanweekmenu2">
                                                            ...
                                                            <div class="dingcanweekmenuinfo" align="left">
                                                                ...
                                                                <li class="newslist_time2">
                                                                    ...
                                                                    <a
                                                                            href="queryMenusById?id=<%=menus1.getId()%>"
