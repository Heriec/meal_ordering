  ...
  <tr>
	...
	%>
		...
		<tr>
			...
			<td  class="line_table"  height="25"  width="80%">
			<input type="text" name="type" size="45" readonly value="<%=menus.getTypes()%>">
			</td>
		</tr>
		<tr>
			<td class="line_table" align="right" width="20%">
			<span class="left_bt2">展示图片</span>：</td>
			<td  class="line_table" width="80%" align="left"><img src="${pageContext.request.contextPath}/public/<%=menus.getImgpath()%>" width="160" height="160"></td>
		</tr>
		<% 	   
	     }
	    %>
		<tr>
			...
			<a href="../../../java/com/he/util/index.jsp" target="_self"><input type="submit" value="返回"></a>
			</td>
		</tr>
