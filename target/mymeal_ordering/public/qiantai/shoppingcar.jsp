            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="left" valign="top">
                        ...
                        <div align="center">
                            <table id="table2" class="line_table" style="width: 700px; margin: 0; padding: 0"
                                ...
                                <tr>
                                    <td class="line_table" align="center" width="40%"><span class="left_bt2">菜品名称</span>
                                    </td>
                                    <td class="line_table" align="center" width="20%"><span class="left_bt2">单价</span>
                                    </td>
                                    <td class="line_table" align="center" width="20%"><span class="left_bt2">数量</span>
                                    </td>
                                    <td class="line_table" align="center" width="20%"><span class="left_bt2">&nbsp;&nbsp;</span>
                                    </td>
                                </tr>
                                    <%
				    float sum1 = 0.0f;
				  ...
				  %>
                                <tr>
                                    <td class="line_table" align="center" width="40%"><span
                                            class="left_txt"><%=sc.getName() %></span></td>
                                    <td class="line_table" align="center" width="20%"><span
                                            class="left_txt"><%=sc.getPrice() %></span></td>
                                    <td class="line_table" align="center" width="20%"><span
                                            class="left_txt"><%=sc.getSums()%></span></td>
					 ...
					 %>
                                ...
                                <tr>
                                    <td class="line_table" align="center" colspan="4" valign="center">
                                        ...
                                        <a href="/orders/order_addShoppingCartoOrder"><img
                                                src="${pageContext.request.contextPath}/public/qiantai/images/canche_submit.gif"
                                                border="0"/></a>

                                        <a href="/orders/order_addShoppingCartoOrder?remove=1">
                                            <img src="${pageContext.request.contextPath}/public/qiantai/images/quxiao2.gif" border="0"/>
                                        </a>
