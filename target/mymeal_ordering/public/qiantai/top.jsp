...
<div id='contain' style='width:900px;background:rgb(255,255,255);margin:0px auto;padding:0px'>
    <div id='top' style='width:900px;height:108px;background:none transparent scroll repeat 0% 0%'>
            ...
            <div id='spdv_3607' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;">
                    <div style="padding:0px">
                        <link href="${pageContext.request.contextPath}/public/qiantai/css/topmenu_bk.css"
                        ...
                        <div id="topmenu">
                            ...
                            <a href="${pageContext.request.contextPath}/users/logout">注销退出</a>|
            ...
            <div id='spdv_3605' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;">
                    ...
                    <div style="padding:0px">
                        ...
                        <link href="${pageContext.request.contextPath}/public/qiantai/css/A.css" rel="stylesheet"
                              type="text/css"/>
                        <script type="text/javascript"
                                src="${pageContext.request.contextPath}/public/qiantai/js/channelmenu_dc.js"></script>
                        ...
                        <div id="menu">
                            ...
                            <div id="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/login.jsp"
                                           target="_self">会员登录</a></li>
                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/shoppingcar.jsp"
                                           target="_self">我的餐车</a></li>

                                    <li><a href="${pageContext.request.contextPath}/orders/queryOrdersById"
                                           target="_self">我的订单</a></li>
                                    <li><a href="${pageContext.request.contextPath}/users/toUpdate"
                                           target="_self" onclick="checkSession()">用户中心</a></li>
                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/carry.jsp"
                                           target="_self">配送说明</a></li>
                                    <li><a href="${pageContext.request.contextPath}/users/logout">注销退出</a></li>
        ...
        <div id='pdv_3608' class='pdv_class' title='' style='width:208px; height:100px; top:-22px; left:0px; z-index:9'>
            <div id='spdv_3608' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;">
                    ...
                    <div style="padding:0px">
                        <img src="${pageContext.request.contextPath}/public/qiantai/images/1257477260.gif" alt=""
                             width="100%" border="0"/>
                    </div>
        ...
        <div id='pdv_3699' class='pdv_class' title=''
             style='width:300px; height:40px; top:-120px; left:600px; z-index:10'>
            <div id='spdv_3699' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;">
                    <div style="height:25px;margin:1px;display:none;">
                        <div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;"></div>
                        <div style="float:right;margin-right:10px;display:none"><a href="-1" style="line-height:25px;">更多</a>
                        </div>
                    </div>
